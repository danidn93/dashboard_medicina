...
import { Database, Zap, LogOut, BarChart3 } from "lucide-react";
        ...
        <div className="flex items-center justify-between">
          <div className="text-center flex-1">
            ...
            <p className="text-xl text-primary-foreground/80">
              Carga archivos, analiza resultados y genera visualizaciones
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card className="border-0 shadow-elegant opacity-70">
            <CardHeader>
              ...
              <CardDescription>
                Visualización consolidada de resultados históricos
                y comparativos institucionales.
              </CardDescription>
            </CardHeader>
            <CardContent>
